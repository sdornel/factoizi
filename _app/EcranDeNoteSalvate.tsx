...
const EcranDeNoteSalvate = () => {
  ...
  return (
    <View style={styles.container}>
      {/* <Pressable onPress={() => navigation.navigate('programare')}><Text>programare</Text></Pressable>
      <Pressable onPress={() => navigation.navigate('istorie')}><Text>istorie</Text></Pressable> */}
    </View>
  );
};
